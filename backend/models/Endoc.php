...
/**
 * This is the model class for table "endoc".
 *
 * @property int $id
 ...
 *
 * @property Entour $tour
 */
class Endoc extends ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['tour_id'], 'exist', 'skipOnError' => true, 'targetClass' => Entour::className(), 'targetAttribute' => ['tour_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(Entour::className(), ['id' => 'tour_id']);
    }*/
}
