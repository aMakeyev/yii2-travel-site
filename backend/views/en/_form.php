...
$dataProvider = new ActiveDataProvider([
	'query' => Endoc::find()->where(['tour_id' => $model->id, 'status' => 1])->orderBy('doc_index'),
]);
?>
<?= Modal::widget([
	'id' => 'doc-win',
...
<div class="entour-form">
	...
	<p>
		<?= Html::a('Добавить документ', ['/endoc/create', 'tour_id' => $model->id], [
			'id' => 'doc-add',
			'data-toggle' => 'modal',
			'data-target' => '#doc-win',
    ...
    <div class="form-group">
		...
		<?= Html::a('Открыть на сайте', '/en/'.$model->route, ['target' => '_blank', 'class' => 'btn btn-primary']) ?>
    </div>
